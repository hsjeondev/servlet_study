...
<body>
		...
		<div id="section_wrap">
			...
			<div class="update_member_form">
				<form action='/memberUpdateEnd' name="update_member_form" method="post">
					...
					<input type="text" name="member_id" value="<%=member.getMemberId() %>" readonly disabled> <br>
					...
					<input type="text" name="member_name" value="<%=member.getMemberName() %>" placeholder="닉네임"> <br>
	...
	const updateMemberForm = function(){
		...
		if(!form.member_id.value){
			...
			// 3. 응답 방식 : JSON
			// 4. content-type : 
			// 5. 요청 데이터 : member_pw, member_name, memeber_no
			// 6. 응답 성공 : res_msg를 alert창에 출력
			//				res_code가 200일 때 /로 이동
		}
	}
	</script>
</body>
