...
<body>
	...
	<ol>
		...
		<li>
			<%-- 1. 다운캐스팅 X 
				 2. getter 알아서 실행됨 필드가 public으로 선언 되어도 getter 없으면 안 됨 --%>
	...
	<p>
		...
		${num1} % ${num2} = ${num1 mod num2}<br>
	</p>
	<h3>2. 문자열 연결</h3>
	<p>${str1} : ${str2}</p>
	<h3>3. 대소 비교</h3>
	<p>
		${num1}이 ${num2}보다 큰가요? : ${num1 gt num2}<br>
		${num1}이 ${num2}보다 작거나 같은가요? : ${num1 le num2}<br>
		${num1}이 ${num2}보다 작은가요? : ${num1 lt num2}<br>
		${num1}이 ${num2}보다 큰거나 같은가요? : ${num1 ge num2}<br>
	</p>
	<h3>4. 동등 비교</h3>
	<p>
		숫자 일치 : ${num1 eq 10}<br>
